...
### F. 사람 판단은 인적 검토로 보냅니다

{: start="40" }
40. `사람 판단` 갈래에 **인적 검토** 노드를 붙입니다.

     ![촬영: 인적 검토 노드](../assets/lab4/lab4-40.png)

41. 검토를 받을 곳으로 **Teams** 를 고르고, 검토자를 지정합니다.

     ![촬영: 인적 검토 구성](../assets/lab4/lab4-41.png)

42. 검토자가 읽을 내용에 요청사항 값을 넣습니다. 사람이 읽고 판단할 수 있어야 합니다.

     ![촬영: 검토 내용 구성](../assets/lab4/lab4-42.png)

43. 저장하고 다시 게시한 뒤, 27번의 첫 문장을 다시 넣습니다.

44. Teams에 검토 요청이 도착하는지 봅니다.

     ![촬영: Teams에 도착한 검토 요청](../assets/lab4/lab4-44.png)

     {: .important }
     **여기가 자동으로 처리하지 않기로 정한 갈래입니다.** 접대비인지 회식비인지는 명세만으로 갈리지 않습니다. 그 판단을 모델에게 맡기지 않고 사람에게 보냅니다.

### G. 기타는 M365 Copilot 으로 보냅니다

{: start="45" }
45. **기타** 갈래에 **M365 Copilot** 노드를 붙입니다.

     ![촬영: 기타 갈래의 M365 Copilot 노드](../assets/lab4/lab4-45.png)

46. 부를 에이전트로 기본 제공되는 **리서처** 를 고릅니다.

     ![촬영: 에이전트 선택 목록의 리서처](../assets/lab4/lab4-46.png)

     {: .important }
     **M365 Copilot 노드도 어느 에이전트를 부를지 고릅니다.** 채널에 게시된 것이면 됩니다. 비용 처리와 관계없는 요청이라 우리 것이 아니라 기본 제공되는 쪽으로 보냅니다.

47. 물어볼 내용으로 요청사항 값을 넘깁니다.

     ![촬영: 질문 지정](../assets/lab4/lab4-47.png)

48. 저장하고 다시 게시한 뒤, 양식에 **비용과 관계없는 글** 을 하나 넣습니다.
...
49. 답이 돌아오는지 봅니다.
     ...
     ![촬영: 기타 갈래로 간 요청과 리서처의 답](../assets/lab4/lab4-49.png)
