...
> **예상 시간**: 25분 · **완성 신호**: 새 대화에서 결과가 사람별로 묶여 나오고, 밖에서 불러도 답한다
...
23. 오른쪽 패널이 무엇을 담는 자리인지 짚어 봅니다.
     ...
     | Channels | **어디서 이 에이전트를 만나나** | 아직 없음. G단에서 붙입니다 |
...
{: start="26" }
26. 오른쪽 **Channels** 의 `+` 를 누르고 `Teams + Microsoft 365` 를 고릅니다.
...
27. 사용 범위를 확인하고 **Add channel** 을 선택합니다. 기본값은 M365 Copilot과 Teams 둘 다입니다.
...
28. **게시** 를 선택하고, 대화상자에서 `Publish agent` 를 누릅니다.
...
29. Teams에서 만든 에이전트를 찾아 아래를 입력합니다.
...
게시하기 전까지 오늘 만든 것은 편집 화면 안에서만 살아 있었습니다. 게시가 그 경계를 넘습니다.
